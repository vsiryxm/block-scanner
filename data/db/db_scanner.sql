...
CREATE TABLE `tb_block` (
  ...
  `scanned_at` timestamp NOT NULL COMMENT '扫描时间',
  `scan_status` tinyint(1) unsigned NOT NULL DEFAULT 0 COMMENT '扫描状态: 0-未完成, 1-已完成',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tb_transaction` (
  ...
  `gas_fee` decimal(36,18) NOT NULL DEFAULT 0.000000000000000000 COMMENT 'gas费',
  `status` tinyint(1) unsigned NOT NULL DEFAULT 0 COMMENT '交易状态: 1-成功, 0-失败',
